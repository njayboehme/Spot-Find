...
static esp_err_t i2c_slave_init(void)
{
    ...
    conf_slave.slave.maximum_speed = I2C_SCLK_MAX; // Needed to add this because of the esp-idf version we are using (Noah)
    conf_slave.clk_flags = 0; // Needed to add this because of the esp-idf version we are using (Noah)
